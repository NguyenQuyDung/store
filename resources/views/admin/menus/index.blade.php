...
<div class="content-wrapper">
    ...
    @include('layouts.content-header', ['name' => 'Trang Chủ', 'key' => 'Menu'])
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('menu.create')}}" class="btn btn-success float-right mb-3">Thêm Menu</a>
                </div>
                <div class="col-md-12">
                    @if($list_menus->total() >0)
                    <style>
                        .analytic a {
                            padding: 0px 2px;
                        }
                        ...
                        <table class="table table-hover table-striped table-checkall">
                            ...
                            @php
                                ...
                                <tr>
                                    ...
                                    <td class="text-primary font-weight-bold">{{$item->user_create}}</td>
                                    ...
                                    @endif
                                    <td>
                                        <a style="width:30px;" href="{{route('menu.edit', $item->id)}}" class="btn btn-success btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                        <a style="width:30px;" href="{{route('menu.delete',$item->id)}}" onclick="return confirm('Bạn Có Chắc Muốn Xóa Danh Mục Sản Phẩm Này !')" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
