...
<div class="content-wrapper">
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <form action="{{route('menu.add')}}" method="POST" class="col-md-6 m-auto">
          @csrf
          <div class="form-group">
            <label for="formGroupExampleInput">Tên Menu</label>
            <input type="text" name="name" class="form-control" id="formGroupExampleInput" placeholder="Nhập tên menu">
            @error('name')
          ...
          <button type="submit" class="form-control btn btn-primary">Thêm Menu</button>
        </form>
        <!-- /.col-md-6 -->
      </div>
      <!-- /.row -->
