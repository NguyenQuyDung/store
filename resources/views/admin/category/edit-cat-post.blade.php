...
<div class="content-wrapper">
  @include('layouts.content-header', ['name' => 'Trang Chủ', 'key' => 'Chỉnh Sửa Danh Mục Bài Viết'])
  <!-- Main content -->
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <form action="{{route('posts.update_cat', $id_cat->id)}}" method="POST" class="col-md-6 m-auto">
          @csrf
